        ...
        <>
            ...
            >
                <a
                    ...
                    className="inline-flex items-center justify-center rounded-full bg-slate-950 px-8 py-4 text-lg font-semibold text-white shadow-[0_12px_30px_rgba(15,23,42,0.18)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(15,23,42,0.22)]"
                    download
                >
            ...
            <section className="bg-white py-16">
                <Container>
                    <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
                        ...
                        <div id="resumen" className="overflow-hidden rounded-[36px] bg-slate-950 text-white shadow-xl">
            ...
            <section id="documentos" className="bg-slate-950 py-20 text-white">
                <Container>
                        ...
                        <div>
                            ...
                            <div className="mt-8 flex flex-wrap gap-3">
                                <a
                                    href={checklistPdfUrl}
                                    download
                                    className="inline-flex items-center justify-center rounded-full bg-slate-950 px-6 py-3.5 font-semibold text-white shadow-[0_12px_30px_rgba(15,23,42,0.18)] transition-all duration-200 hover:-translate-y-0.5"
                                >
                                    Descargar PDF
                                </a>
