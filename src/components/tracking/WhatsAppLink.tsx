...
import { trackEvent, GA4_EVENTS } from './ga4';
import { getWhatsAppUrl, SERVICE_TO_MESSAGE_KEY } from '@/lib/whatsapp';
...
function WhatsAppLink({
    ...
    const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
        const eventName = effectiveKey !== 'general'
            ? GA4_EVENTS.CLICK_WHATSAPP_SERVICIO(effectiveKey)
            : GA4_EVENTS.CLICK_WHATSAPP_GENERAL;

        trackEvent(eventName, { message_key: effectiveKey });
        onClick?.(e);
    };
    ...
    return (
        ...
        >
            ...
            {children || (variant !== 'icon' && 'Contactar por WhatsApp')}
        </a>
    );
}

export { WhatsAppLink, type WhatsAppLinkProps };
