        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    {
                        'bg-[linear-gradient(135deg,#172554_0%,#1E3A5F_58%,#0E7490_100%)] text-white shadow-[0_12px_30px_rgba(23,37,84,0.18)] hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(23,37,84,0.22)] focus-visible:ring-slate-300':
                            variant === 'primary',
